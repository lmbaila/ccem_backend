...
exports.CreateOriginUseCase = void 0;
...
let CreateOriginUseCase = class CreateOriginUseCase {
    constructor(repo) {
        this.repo = repo;
    }
    async execute(dto) {
...
exports.CreateOriginUseCase = CreateOriginUseCase;
exports.CreateOriginUseCase = CreateOriginUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(origin_repository_1.ORIGIN_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], CreateOriginUseCase);
//# sourceMappingURL=create-origin.usecase.js.map